                ...
                {[10, 66, 122, 178, 234, 290, 346, 402, 468, 524].map((y, idx) => {
                    return (
                        <React.Fragment key={idx}>
                            ...
                            <rect x="128" y={y} rx="4" ry="4" width="130" height="38" />
                            <rect x="278" y={y} rx="4" ry="4" width="500" height="38" />
                            <rect x="808" y={y} rx="4" ry="4" width="130" height="38" />
                            <rect x="978" y={y} rx="4" ry="4" width="130" height="38" />
                        </React.Fragment>
                    );
                })}
            </ContentLoader>
