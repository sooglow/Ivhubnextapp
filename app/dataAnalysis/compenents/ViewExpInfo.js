    ...
    return (
        <div className="col-span-2 grid grid-cols-6 gap-4 border p-5 rounded-xl text-sm">
            <div className="col-span-6 text-right">
                <Button
                    variant="outline"
                    onClick={deleteExpCode}
                    disabled={!selectedEpcCode || !selectedSeqno || !selectedVin || !selectedIvCode}
                >
                    <i className="fa-regular fa-trash pr-2" />
                    삭제
                </Button>
            </div>
                ...
                <Input
                    ...
                    value={
                        expList[
                            expList.findIndex(
                                (item) =>
                                    item.seqno === selectedSeqno &&
                                    item.epc_code === selectedEpcCode
                            )
                        ]?.tire_size || ""
                    }
                />
