...
export default function AsCaseCreate() {
    ...
    // AS 코드 목록 조회 - prgCode 변경 시 자동으로 재요청됨
    const { data: asData } = useQuery({
                        ...
                        <ul className="space-y-4 pt-0 md:pt-3 md:p-2">
                            ...
                            <div className="mx-4 pb-8">
                                ...
                                <div className="border rounded-md border-[#E1E1E1]">
                                    <textarea
                                        className="w-full h-[300px] px-4 overflow-scroll overflow-x-hidden focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 pt-1"
                                        value={question}
